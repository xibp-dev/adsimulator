...
export default async function DashboardHubPage() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-8">
      ...
      {/* Promo Kelas Premium (LMS) */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#0f1729] via-[#15233f] to-[#0866FF] p-6">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#0866FF] opacity-20 blur-[90px] rounded-full -translate-y-1/3 translate-x-1/4" />
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="inline-flex items-center gap-1.5 bg-white/10 text-white/80 text-[11px] font-semibold px-2.5 py-0.5 rounded-full mb-1.5 border border-white/10">
                <Crown className="w-3 h-3 text-amber-300" /> Baru · Kelas Premium
              </div>
              <h3 className="text-lg font-bold text-white">Mau jago Meta Ads lebih cepat?</h3>
              <p className="text-white/60 text-sm mt-0.5 max-w-lg">
                Ikuti kelas terstruktur dari pemula sampai mahir. Simulator tetap <strong className="text-emerald-300">gratis</strong> — langganan hanya untuk membuka materi belajar.
              </p>
            </div>
          </div>
          <Link href="/dashboard/langganan" className="bg-white text-[#0866FF] font-bold text-sm px-5 py-2.5 rounded-xl whitespace-nowrap hover:bg-blue-50 transition-colors flex items-center gap-1.5 self-start md:self-center">
